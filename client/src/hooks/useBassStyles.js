...
const defaults = {
  ...
  __color_highlight: "#eda42d",
  __base_font_size: 12,
  __number_of_steps: 16,
  __number_of_bass_tracks: 8,
  __grid_unit: 2,
  __play_head_width: 2,
...
const setStyles = (totalSteps) => {
  ...
  setProperty(
    "--bass-play-head-height",
    noteHeightFull * defaults.__number_of_bass_tracks -
...
const useBassStyles = (totalSteps) => {
  useEffect(() => {
